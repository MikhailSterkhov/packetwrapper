...
public class WrapperPlayServerResourcePackSend1_15 
        extends MinecraftPacket
        implements WrapperPlayServerResourcePackSend {

	public WrapperPlayServerResourcePackSend1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerResourcePackSend1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
