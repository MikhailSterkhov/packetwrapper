...
public class WrapperPlayClientClientCommand1_15 
        extends MinecraftPacket
        implements WrapperPlayClientClientCommand {

	public WrapperPlayClientClientCommand1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientClientCommand1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
