...
public class WrapperPlayServerSpawnEntityLiving1_15 
        extends MinecraftPacket
        implements WrapperPlayServerSpawnEntityLiving {
	private static PacketConstructor entityConstructor;

	public WrapperPlayServerSpawnEntityLiving1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerSpawnEntityLiving1_15(PacketContainer packet) {
		super(packet, TYPE);
	}

	public WrapperPlayServerSpawnEntityLiving1_15(Entity entity) {
