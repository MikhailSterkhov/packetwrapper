...
public class WrapperPlayServerScoreboardTeam1_15 
        extends MinecraftPacket
        implements WrapperPlayServerScoreboardTeam {

	public WrapperPlayServerScoreboardTeam1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerScoreboardTeam1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
	...
	public WrappedChatComponent getSuffix() {
		return container.getChatComponents().read(2);
	}
	...
	public void setSuffix(WrappedChatComponent value) {
		container.getChatComponents().write(2, value);
	}
	...
	public ChatColor getColor() {
		return container.getEnumModifier(ChatColor.class, MinecraftReflection.getMinecraftClass("EnumChatFormat")).read(0);
	}
	...
	public void setColor(ChatColor value) {
		container.getEnumModifier(ChatColor.class, MinecraftReflection.getMinecraftClass("EnumChatFormat")).write(0, value);
	}
	...
	public String getCollisionRule() {
		return container.getStrings().read(2);
	}
	...
	public void setCollisionRule(String value) {
		container.getStrings().write(2, value);
	}
