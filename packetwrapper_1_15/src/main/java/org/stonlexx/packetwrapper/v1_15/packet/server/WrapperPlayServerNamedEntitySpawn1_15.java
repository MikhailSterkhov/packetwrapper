...
import org.stonlexx.packetwrapper.api.packet.server.WrapperPlayServerNamedEntitySpawn;

import java.util.UUID;

public class WrapperPlayServerNamedEntitySpawn1_15 
        extends MinecraftPacket
        implements WrapperPlayServerNamedEntitySpawn {

	public WrapperPlayServerNamedEntitySpawn1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerNamedEntitySpawn1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
