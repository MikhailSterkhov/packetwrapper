...
public class WrapperPlayServerCustomSoundEffect1_15 
        extends MinecraftPacket
        implements WrapperPlayServerCustomSoundEffect {

	public WrapperPlayServerCustomSoundEffect1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerCustomSoundEffect1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
