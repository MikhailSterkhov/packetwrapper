...
public class WrapperPlayServerRelEntityMoveLook1_15 
        extends MinecraftPacket
        implements WrapperPlayServerRelEntityMoveLook {

	public WrapperPlayServerRelEntityMoveLook1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerRelEntityMoveLook1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
	 ...
	 */
	public double getDx() {
		return container.getShorts().read(0) / 4096D;
	}
	...
	public void setDx(double value) {
		container.getShorts().write(0, (short) (value * 4096));
	}
	 ...
	 */
	public double getDy() {
		return container.getShorts().read(1) / 4096D;
	}
	...
	public void setDy(double value) {
		container.getShorts().write(1, (short) (value * 4096));
	}
	 ...
	 */
	public double getDz() {
		return container.getShorts().read(2) / 4096D;
	}
	...
	public void setDz(double value) {
		container.getShorts().write(2, (short) (value * 4096));
	}
