...
import org.stonlexx.packetwrapper.api.packet.client.WrapperPlayClientVehicleMove;


public class WrapperPlayClientVehicleMove1_15 
        extends MinecraftPacket
        implements WrapperPlayClientVehicleMove {

	public WrapperPlayClientVehicleMove1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientVehicleMove1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
