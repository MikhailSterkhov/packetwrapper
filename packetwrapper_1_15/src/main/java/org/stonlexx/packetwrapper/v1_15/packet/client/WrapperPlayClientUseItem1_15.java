...
public class WrapperPlayClientUseItem1_15 
        extends MinecraftPacket
        implements WrapperPlayClientUseItem {

	public WrapperPlayClientUseItem1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientUseItem1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
	...
	public MovingObjectPosition getPosition() {
		return container.getModifier().withType(POSITION_CLASS, AUTO_WRAPPER).read(0);
	}

	public void setPosition(MovingObjectPosition position) {
		container.getModifier().withType(POSITION_CLASS, AUTO_WRAPPER).write(0, position);
	}
}
