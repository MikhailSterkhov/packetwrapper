...
public class WrapperPlayServerRelEntityMove1_15 
        extends MinecraftPacket
        implements WrapperPlayServerRelEntityMove {

	public WrapperPlayServerRelEntityMove1_15() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerRelEntityMove1_15(PacketContainer packet) {
		super(packet, TYPE);
	}
