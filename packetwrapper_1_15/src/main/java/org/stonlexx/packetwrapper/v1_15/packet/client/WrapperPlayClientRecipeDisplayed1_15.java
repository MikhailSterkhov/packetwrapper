...
public class WrapperPlayClientRecipeDisplayed1_15 
        extends MinecraftPacket
        implements WrapperPlayClientRecipeDisplayed {

    public WrapperPlayClientRecipeDisplayed1_15() {
        super(new PacketContainer(TYPE), TYPE);
        container.getModifier().writeDefaults();
    }
    
    public WrapperPlayClientRecipeDisplayed1_15(PacketContainer packet) {
        super(packet, TYPE);
    }
