...
import org.stonlexx.packetwrapper.api.packet.client.WrapperPlayClientTransaction;

public class WrapperPlayClientTransaction1_12 
        extends MinecraftPacket
        implements WrapperPlayClientTransaction {

	public WrapperPlayClientTransaction1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientTransaction1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
