...
public class WrapperPlayServerEntityDestroy1_12 
        extends MinecraftPacket
        implements WrapperPlayServerEntityDestroy {

	public WrapperPlayServerEntityDestroy1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerEntityDestroy1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
