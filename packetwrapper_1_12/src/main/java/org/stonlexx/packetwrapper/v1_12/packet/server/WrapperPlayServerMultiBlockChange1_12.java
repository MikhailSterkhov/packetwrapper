...
public class WrapperPlayServerMultiBlockChange1_12 
        extends MinecraftPacket
        implements WrapperPlayServerMultiBlockChange {

	public WrapperPlayServerMultiBlockChange1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerMultiBlockChange1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
