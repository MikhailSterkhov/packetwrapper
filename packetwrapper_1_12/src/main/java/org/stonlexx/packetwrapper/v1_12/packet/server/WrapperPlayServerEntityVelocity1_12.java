...
public class WrapperPlayServerEntityVelocity1_12 
        extends MinecraftPacket
        implements WrapperPlayServerEntityVelocity {

	public WrapperPlayServerEntityVelocity1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerEntityVelocity1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
