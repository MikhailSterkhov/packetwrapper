...
public class WrapperPlayServerEntityTeleport1_12 
        extends MinecraftPacket
        implements WrapperPlayServerEntityTeleport {

	public WrapperPlayServerEntityTeleport1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerEntityTeleport1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
