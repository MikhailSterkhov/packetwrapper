...
public class WrapperPlayServerPlayerListHeaderFooter1_12 
        extends MinecraftPacket
        implements WrapperPlayServerPlayerListHeaderFooter {

	public WrapperPlayServerPlayerListHeaderFooter1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerPlayerListHeaderFooter1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
