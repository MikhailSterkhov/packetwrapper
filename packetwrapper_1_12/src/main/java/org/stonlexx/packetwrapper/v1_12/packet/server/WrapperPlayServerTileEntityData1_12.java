...
public class WrapperPlayServerTileEntityData1_12 
        extends MinecraftPacket
        implements WrapperPlayServerTileEntityData {

	public WrapperPlayServerTileEntityData1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerTileEntityData1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
