...
public class WrapperPlayServerSpawnEntity1_12 
        extends MinecraftPacket
        implements WrapperPlayServerSpawnEntity {

	private static PacketConstructor entityConstructor;

	public WrapperPlayServerSpawnEntity1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerSpawnEntity1_12(PacketContainer packet) {
		super(packet, TYPE);
	}

	public WrapperPlayServerSpawnEntity1_12(Entity entity, int type, int objectData) {
	...
	public EntityType getType() {
		return EntityType.fromId(container.getIntegers().read(6));
	}

	@Override
	public void setType(EntityType value) {
		setType(value.getTypeId());
	}
	...
	public int getObjectData() {
		return container.getIntegers().read(7);
	}
	...
	public void setObjectData(int value) {
		container.getIntegers().write(7, value);
	}
}
