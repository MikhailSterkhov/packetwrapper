...
public class WrapperPlayClientCustomPayload1_12 
        extends MinecraftPacket
        implements WrapperPlayClientCustomPayload {

	public WrapperPlayClientCustomPayload1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientCustomPayload1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
