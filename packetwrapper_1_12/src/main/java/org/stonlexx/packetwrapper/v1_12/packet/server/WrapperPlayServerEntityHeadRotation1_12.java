...
public class WrapperPlayServerEntityHeadRotation1_12 
        extends MinecraftPacket
        implements WrapperPlayServerEntityHeadRotation {

	public WrapperPlayServerEntityHeadRotation1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerEntityHeadRotation1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
