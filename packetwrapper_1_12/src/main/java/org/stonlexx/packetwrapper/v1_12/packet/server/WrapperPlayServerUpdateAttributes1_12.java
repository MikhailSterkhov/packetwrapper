...
public class WrapperPlayServerUpdateAttributes1_12 
        extends MinecraftPacket
        implements WrapperPlayServerUpdateAttributes {

	public WrapperPlayServerUpdateAttributes1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerUpdateAttributes1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
