...
public class WrapperPlayServerScoreboardScore1_12 
        extends MinecraftPacket
        implements WrapperPlayServerScoreboardScore {

	public WrapperPlayServerScoreboardScore1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerScoreboardScore1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
