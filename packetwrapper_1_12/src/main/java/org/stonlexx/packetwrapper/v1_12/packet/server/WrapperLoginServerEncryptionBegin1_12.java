...
public class WrapperLoginServerEncryptionBegin1_12 
        extends MinecraftPacket
        implements WrapperLoginServerEncryptionBegin {

	public WrapperLoginServerEncryptionBegin1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperLoginServerEncryptionBegin1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
