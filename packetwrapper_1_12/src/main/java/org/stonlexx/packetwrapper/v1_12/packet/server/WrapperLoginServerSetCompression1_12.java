...
public class WrapperLoginServerSetCompression1_12 
        extends MinecraftPacket
        implements WrapperLoginServerSetCompression {

	public WrapperLoginServerSetCompression1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperLoginServerSetCompression1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
