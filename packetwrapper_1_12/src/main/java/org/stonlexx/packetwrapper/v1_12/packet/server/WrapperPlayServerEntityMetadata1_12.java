...
public class WrapperPlayServerEntityMetadata1_12 
        extends MinecraftPacket
        implements WrapperPlayServerEntityMetadata {

	public WrapperPlayServerEntityMetadata1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerEntityMetadata1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
