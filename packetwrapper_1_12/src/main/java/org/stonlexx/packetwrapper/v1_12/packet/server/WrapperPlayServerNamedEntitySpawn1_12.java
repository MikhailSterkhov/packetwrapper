...
public class WrapperPlayServerNamedEntitySpawn1_12 
        extends MinecraftPacket
        implements WrapperPlayServerNamedEntitySpawn {

	public WrapperPlayServerNamedEntitySpawn1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerNamedEntitySpawn1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
