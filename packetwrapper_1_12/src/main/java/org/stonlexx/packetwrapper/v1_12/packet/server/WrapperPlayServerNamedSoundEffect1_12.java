...
public class WrapperPlayServerNamedSoundEffect1_12 
        extends MinecraftPacket
        implements WrapperPlayServerNamedSoundEffect {

	public WrapperPlayServerNamedSoundEffect1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerNamedSoundEffect1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
