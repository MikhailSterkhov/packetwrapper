...
public class WrapperPlayServerSpawnEntityWeather1_12 
        extends MinecraftPacket
        implements WrapperPlayServerSpawnEntityWeather {

	public WrapperPlayServerSpawnEntityWeather1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerSpawnEntityWeather1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
