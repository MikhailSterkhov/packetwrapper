...
public class WrapperHandshakingClientSetProtocol1_12 
        extends MinecraftPacket
        implements WrapperHandshakingClientSetProtocol {

	public WrapperHandshakingClientSetProtocol1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperHandshakingClientSetProtocol1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
