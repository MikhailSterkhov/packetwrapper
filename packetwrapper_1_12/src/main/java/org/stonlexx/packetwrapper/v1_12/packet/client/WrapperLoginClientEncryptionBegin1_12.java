...
public class WrapperLoginClientEncryptionBegin1_12 
        extends MinecraftPacket
        implements WrapperLoginClientEncryptionBegin {

	public WrapperLoginClientEncryptionBegin1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperLoginClientEncryptionBegin1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
