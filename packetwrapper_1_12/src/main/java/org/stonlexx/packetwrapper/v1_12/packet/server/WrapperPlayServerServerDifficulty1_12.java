...
public class WrapperPlayServerServerDifficulty1_12 
        extends MinecraftPacket
        implements WrapperPlayServerServerDifficulty {

	public WrapperPlayServerServerDifficulty1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerServerDifficulty1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
