...
public class WrapperPlayClientSetCreativeSlot1_12 
        extends MinecraftPacket
        implements WrapperPlayClientSetCreativeSlot {

	public WrapperPlayClientSetCreativeSlot1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientSetCreativeSlot1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
