...
public class WrapperPlayServerRemoveEntityEffect1_12 
        extends MinecraftPacket
        implements WrapperPlayServerRemoveEntityEffect {

	public WrapperPlayServerRemoveEntityEffect1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerRemoveEntityEffect1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
