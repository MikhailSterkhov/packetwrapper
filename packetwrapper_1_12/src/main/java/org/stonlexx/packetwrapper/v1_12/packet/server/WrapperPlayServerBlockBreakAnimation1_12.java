...
public class WrapperPlayServerBlockBreakAnimation1_12 
        extends MinecraftPacket
        implements WrapperPlayServerBlockBreakAnimation {

	public WrapperPlayServerBlockBreakAnimation1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerBlockBreakAnimation1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
