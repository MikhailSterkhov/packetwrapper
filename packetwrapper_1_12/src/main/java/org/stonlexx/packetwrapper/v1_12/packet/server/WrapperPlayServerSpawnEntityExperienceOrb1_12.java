...
public class WrapperPlayServerSpawnEntityExperienceOrb1_12 
        extends MinecraftPacket
        implements WrapperPlayServerSpawnEntityExperienceOrb {

	public WrapperPlayServerSpawnEntityExperienceOrb1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayServerSpawnEntityExperienceOrb1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
