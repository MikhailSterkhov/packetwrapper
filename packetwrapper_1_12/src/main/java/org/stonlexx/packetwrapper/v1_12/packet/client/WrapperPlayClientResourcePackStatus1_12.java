...
public class WrapperPlayClientResourcePackStatus1_12 
        extends MinecraftPacket
        implements WrapperPlayClientResourcePackStatus {

	public WrapperPlayClientResourcePackStatus1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientResourcePackStatus1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
