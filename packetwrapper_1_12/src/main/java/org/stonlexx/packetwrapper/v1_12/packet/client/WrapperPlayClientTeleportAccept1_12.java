...
public class WrapperPlayClientTeleportAccept1_12 
        extends MinecraftPacket
        implements WrapperPlayClientTeleportAccept {


	public WrapperPlayClientTeleportAccept1_12() {
		super(new PacketContainer(TYPE), TYPE);
		container.getModifier().writeDefaults();
	}

	public WrapperPlayClientTeleportAccept1_12(PacketContainer packet) {
		super(packet, TYPE);
	}
